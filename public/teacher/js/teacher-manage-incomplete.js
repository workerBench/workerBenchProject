    ...
    .then((response) => {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        switch (status) {
          case 'request':
            buttonHtml = `
                <button type="radio" class="Button" id="requestButton">수락 하기</button>
          ...
          case 'non_payment':
            buttonHtml = `
                <button type="radio" class="Button" id="approvalButton">결제 대기</button>
                <button type="radio" class="Button" id="rejectButton">취소 하기</button>
                <button type="radio" class="Button" id="editButton">수정 하기</button>
            `;
            break;
          case 'waiting_lecture':
            buttonHtml = `
                <button type="radio" class="Button" id="completeButton">결제 완료</button>
                <button type="radio" class="Button" id="rejectButton">취소 하기</button>
                <button type="radio" class="Button" id="editButton">수정 하기</button>
            `;
            break;
