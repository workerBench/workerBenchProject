...
const jwtRefreshExtractorFromCookies_1 = require("../../common/utils/jwtRefreshExtractorFromCookies");
    ...
    constructor(authService, configService) {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromExtractors([
                jwtRefreshExtractorFromCookies_1.jwtRefreshExtractorFromCookies,
            ]),
